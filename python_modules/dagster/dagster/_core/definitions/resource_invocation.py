...
def _check_invocation_requirements(
    ...
    # console log manager.
    with (
        init_context or cast("UnboundInitResourceContext", build_init_resource_context())
    ) as open_context:
        return InitResourceContext(
            resource_config=resource_config,
            resources=open_context.resources,
            resource_def=resource_def,
            instance=open_context.instance,
            log_manager=open_context.log,
        )
